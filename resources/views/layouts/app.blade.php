...
<body class="sidebar-mini layout-fixed" style="height: auto;"> <!--layout-fixed en vez de sidebar.collapse-->
    ...
    <div class="wrapper">
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <div class="sidebar">
                    ...
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                        <div class="image">
                            {{-- <img src="https://ui-avatars.com/api/?name=Cristhian%20Quiroga&background=0D8ABC&color=fff" class="img-circle elevation-2" alt="User Image"> --}}
                        ...
                        <div class="info">
                            {{-- {{ auth()->user()->name}} me devuelve el name del ususario autenticado --}}
        ...
        <div class="content-wrapper" style="min-height: 589.4px;">
            @yield('content')  <!--Aqui mostramos la card o targjeta de content-->
        ...
        <footer class="main-footer">
            ...
            <div class="float-right d-none d-sm-inline">
                Desarrollado por @CristhianQuiroga
            </div>
